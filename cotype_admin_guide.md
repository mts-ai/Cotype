...
2. *Однотокеновая авторизация*
   ...
   Вид авторизации можно установить через переменные окружения. Подробности смотрите в разделе [4 — Проверка и конфигурация ENV-файла](#4-проверка-и-конфигурация-env-файла4).
...
Подробнее о переменных смотрите в разделе [4.6 — Переменные журналирования](#46-переменные-журналирования46).
...
1. С помощью API-запроса `GET/health`. Запрос подробно описан в пункте [5.3 - GET/health](#53-gethealth).
...
**Таблица 5.1**. Переменные окружения для запуска сервиса на нескольких видеокартах.
...
Переменная настройки генерации модели устанавливаеи ограничение при обработке запросов `POST/v1/chat/completions`.

**Таблица 8**. Переменная настройки генерации модели.
...
**Таблица 9**. Переменные журналирования.
...
Описание переменных окружения и параметров для запуска Cotype на нескольких видеокартах смотрите в таблице 5. 
...
**Таблица 11.** Параметры запроса `POST/v1/chat/completions`
...
**Таблица 12**. Параметры ответа на запрос POST/v1/chat/completions
...
**Таблица 13**. Параметры запроса POST/v1/completions
...
**Таблица 14**. Параметры ответа на запрос POST/v1/completions
...
|request| Тело запроса. | <code>{<br>&nbsp;&nbsp;"model":"cotype_light_8k_3.0",<br>&nbsp;&nbsp; "temperature": 0.2 ,<br>&nbsp;&nbsp; "messages": [<br>&nbsp;&nbsp;&nbsp;&nbsp;{"role": "user", "Тестовый запрос"}<br>&nbsp;&nbsp;&nbsp;&nbsp;]<br>} </code> |
|request_dt|Время получения запроса. | 2024-10-08 08:02:28.283771  |
|response|Ответ системы на запрос. |<code> {<br>&nbsp;&nbsp; id":"chat-9e27bbe53aac497e88bdf43f15e93a7e",<br>&nbsp;&nbsp; "object":"chat.completion", <br>&nbsp;&nbsp;"created":1728374548,<br>&nbsp;&nbsp; "model":"cotype_light_8k_3.0",<br>&nbsp;&nbsp; "choices": [<br>&nbsp;&nbsp;&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"index":0,<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"message":<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{ <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"role":"assistant", <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;content":"Привет! Чем я могу помочь?", <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"tool_calls":[]<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;},<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; "logprobs":null, <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"finish_reason":"stop",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; "stop_reason":null<br>&nbsp;&nbsp;&nbsp;&nbsp;}],<br>&nbsp;&nbsp;&nbsp;&nbsp; "usage":<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"prompt_tokens":8,<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; "total_tokens":18, <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"completion_tokens":10<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;},<br>&nbsp;&nbsp; "prompt_logprobs":null <br>} </code>  |
