...
2. *Однотокеновая авторизация*
   ...
   Вид авторизации можно установить через переменные окружения. Подробности смотрите в разделе [Проверка и конфигурация ENV-файла](#проверка_и_конфигурация_env_файла).
